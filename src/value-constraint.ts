...
// The construct catalogue moved to constructs.ts so every level shares one
// list; re-exported here for the call sites that already import from this
// module.
export { CONSTRUCT_NAMES, suggestConstruct } from "./constructs.js";
